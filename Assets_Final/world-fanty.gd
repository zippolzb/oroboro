...
@onready var starting_items = [
	# ==== PLAYER ====
	{'node_name': 'Player', 'node': $CharacterBody3D, 'pos': Vector3(3,1.25,3)},
	# ==== ITEMS ====
	{'node_name': 'Libro', 'node': $"Starting-Mesas/Mesa-Libro", 'pos': Vector3(6,1.25,6)},
	{'node_name': 'Cabinet', 'node': $"Starting-Mesas/Mesa-Biblio", 'pos': Vector3(2,1.25,2)},
	{'node_name': 'Cruz', 'node': $"Starting-Mesas/Mesa-Cruz", 'pos': Vector3(3,1.25,2)},
	# ==== MOBS ====
	{'node_name': 'Mob', 'node': $Mobs/Vampi, 'pos': Vector3(3,0.5,4)},
	{'node_name': 'Mob', 'node': $Mobs/Vampi2, 'pos': Vector3(4,0.5,3)},
	# ==== WALLS ====
	{'node_name': 'Mesa', 'node': $Walls/Mesa, 'pos': Vector3(2,1.25,4)}
]
# DEFINING LOOP
...
func place_starting_items():	for item in starting_items:
