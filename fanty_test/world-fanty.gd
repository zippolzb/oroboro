...
@onready var starting_items = [
	# ==== PLAYER ====
	{'node_name': 'Player', 'node': $CharacterBody3D, 'pos': Vector3(4,1.25,4)},
	# ==== ITEMS ====
	{'node_name': 'Libro', 'node': $"Starting-Mesas/Mesa-Libro", 'pos': Vector3(5,1.25,5)},
	{'node_name': 'Cabinet', 'node': $"Starting-Mesas/Mesa-Biblio", 'pos': Vector3(4,1.25,2)},
	# ==== MOBS ====
	{'node_name': 'Mob-Fanty', 'node': $Mobs/Fanty, 'pos': Vector3(4,0.5,5)},
	{'node_name': 'Mob-Fanty', 'node': $Mobs/Fanty2, 'pos': Vector3(3,0.5,5)},
	{'node_name': 'Mob-Fanty', 'node': $Mobs/Fanty3, 'pos': Vector3(5,0.5,4)},
	# ==== WALLS ====
