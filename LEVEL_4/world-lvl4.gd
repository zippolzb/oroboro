...
@onready var starting_items = [
	# ==== PLAYER ====
	{'node_name': 'Player', 'node': $CharacterBody3D, 'pos': Vector3(3,1.25,6)},
	# ==== ITEMS ====
	{'node_name': 'Libro', 'node': $"Starting-Mesas/Mesa-Libro", 'pos': Vector3(3,1.25,5)},
	{'node_name': 'Cabinet', 'node': $"Starting-Mesas/Mesa-Biblio", 'pos': Vector3(5,1.25,1)},
	# ==== WALLS ====
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle, 'pos': Vector3(2,1.25,6)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle2, 'pos': Vector3(3,1.25,4)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle3, 'pos': Vector3(3,1.25,3)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle4, 'pos': Vector3(3,1.25,2)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle5, 'pos': Vector3(3,1.25,1)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle6, 'pos': Vector3(4,1.25,5)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle7, 'pos': Vector3(4,1.25,1)},
	{'node_name': 'Mesa', 'node': $Walls/Mesa8, 'pos': Vector3(5,1.25,3)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle9, 'pos': Vector3(6,1.25,1)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle10, 'pos': Vector3(6,1.25,3)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle11, 'pos': Vector3(6,1.25,4)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle12, 'pos': Vector3(6,1.25,5)},
	{'node_name': 'Mesa', 'node': $Walls/Mesa13, 'pos': Vector3(6,1.25,6)},
]
# DEFINING LOOP
