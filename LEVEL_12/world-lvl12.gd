...
@onready var next_level = 'res://LEVEL_13/world-lvl13.tscn'
@onready var bg_sound = $"../Sounds/BgMusic"

# STARTING PLAYER AND ITEMS
@onready var starting_items = [
	# ==== PLAYER ====
	{'node_name': 'Player', 'node': $CharacterBody3D, 'pos': Vector3(1,1.25,6)},
	# ==== ITEMS ====
	{'node_name': 'Libro', 'node': $"Starting-Mesas/Mesa-Libro", 'pos': Vector3(6,1.25,1)},
	{'node_name': 'Cabinet', 'node': $"Starting-Mesas/Mesa-Biblio", 'pos': Vector3(5,1.25,5)},
	{'node_name': 'Cruz', 'node': $"Starting-Mesas/Mesa-Cruz", 'pos': Vector3(4,1.25,5)},
	# ==== MOBS ====
	{'node_name': 'Mob', 'node': $Mobs/Vampi, 'pos': Vector3(3,0.5,4)},
	{'node_name': 'Mob', 'node': $Mobs/Vampi2, 'pos': Vector3(4,0.5,6)},
	{'node_name': 'Mob', 'node': $Mobs/Vampi3, 'pos': Vector3(6,0.5,3)},

	# ==== WALLS ====
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle1, 'pos': Vector3(1,1.25,5)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle2, 'pos': Vector3(2,1.25,1)},
	{'node_name': 'Mesa', 'node': $Walls/Mesa3, 'pos': Vector3(2,1.25,2)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle4, 'pos': Vector3(2,1.25,3)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle5, 'pos': Vector3(2,1.25,4)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle6, 'pos': Vector3(2,1.25,5)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle7, 'pos': Vector3(4,1.25,3)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle8, 'pos': Vector3(4,1.25,4)},
	{'node_name': 'Mesa', 'node': $Obstacles/Carn_Plant, 'pos': Vector3(6,1.25,2)},
	{'node_name': 'Mesa', 'node': $Obstacles/Carn_Plant2, 'pos': Vector3(6,1.25,4)},
	{'node_name': 'Mesa', 'node': $Walls/Mesa11, 'pos': Vector3(6,1.25,5)},
