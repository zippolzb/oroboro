...
@onready var next_level = 'res://LEVEL_11/world-lvl11.tscn'
@onready var bg_sound = $"../Sounds/BgMusic"

# STARTING PLAYER AND ITEMS
@onready var starting_items = [
	# ==== PLAYER ====
	{'node_name': 'Player', 'node': $CharacterBody3D, 'pos': Vector3(4,1.25,6)},
	# ==== ITEMS ====
	{'node_name': 'Libro', 'node': $"Starting-Mesas/Mesa-Libro", 'pos': Vector3(4,1.25,2)},
