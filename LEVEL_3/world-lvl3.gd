...
@onready var starting_items = [
	...
	# ==== WALLS ====
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle, 'pos': Vector3(6,1.25,6)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle2, 'pos': Vector3(4,1.25,6)},
	...
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle6, 'pos': Vector3(6,1.25,4)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle7, 'pos': Vector3(6,1.25,3)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle8, 'pos': Vector3(4,1.25,3)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle9, 'pos': Vector3(4,1.25,2)},
