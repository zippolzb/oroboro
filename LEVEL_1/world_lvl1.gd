...
@onready var next_level = "res://LEVEL_2/world-lvl2.tscn"
...
@onready var starting_items = [
	...
	# ==== WALLS ====
	{'node_name': 'Mesa', 'node': $Obstacles/Watercooler, 'pos': Vector3(6,1.25,5)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle, 'pos': Vector3(4,1.25,5)},
