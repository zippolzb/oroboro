...
@onready var next_level = 'res://LEVEL_8/world-lvl8.tscn'
@onready var bg_sound = $"../Sounds/BgMusic"
"res://victory.tscn"
# STARTING PLAYER AND ITEMS
@onready var starting_items = [
	# ==== PLAYER ====
	{'node_name': 'Player', 'node': $CharacterBody3D, 'pos': Vector3(2,1.25,6)},
	# ==== ITEMS ====
	{'node_name': 'Libro', 'node': $"Starting-Mesas/Mesa-Libro", 'pos': Vector3(2,1.25,5)},
	{'node_name': 'Cabinet', 'node': $"Starting-Mesas/Mesa-Biblio", 'pos': Vector3(2,1.25,1)},
	# ==== MOBS ====
	{'node_name': 'Mob', 'node': $Mobs/Skeleton, 'pos': Vector3(1,0.5,4)},
	{'node_name': 'Mob', 'node': $Mobs/Skeleton2, 'pos': Vector3(3,0.5,4)},
	{'node_name': 'Mob', 'node': $Mobs/Skeleton3, 'pos': Vector3(5,0.5,4)},
	# ==== WALLS ====
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle, 'pos': Vector3(2,1.25,3)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle2, 'pos': Vector3(2,1.25,4)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle3, 'pos': Vector3(4,1.25,4)},
	{'node_name': 'Mesa', 'node': $Walls/Mesa4, 'pos': Vector3(4,1.25,5)},
	{'node_name': 'Mesa', 'node': $Walls/Mesa5, 'pos': Vector3(6,1.25,5)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle6, 'pos': Vector3(3,1.25,1)},
	{'node_name': 'Mesa', 'node': $Walls/Mesa7, 'pos': Vector3(4,1.25,1)},
	{'node_name': 'Mesa', 'node': $Obstacles/Cubicle8, 'pos': Vector3(5,1.25,1)},
]
# DEFINING LOOP
@onready var level_loop_dict = [
	...
	{'node':$GUI/Interact2, 'type': 'Interactuar', 'image':'res://gui/interact.png', 'used_image':'res://gui/interact_used.png'},
]
